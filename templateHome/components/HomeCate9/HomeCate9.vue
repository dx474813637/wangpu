<template>
	<view class="homebg">
		...
		<view class="header homebg u-padding-l-r">
			...
			<view class="search">
				<u-search shape="rect" bg-color="#f8f8f8" height="60" color="#000" :show-action="false"
		...
		<view class="product-wrapper homebg u-margin-bottom-20" v-if="list.images.length != 0">
			...
			<scroll-view class="wrapper-list-x" :scroll-x="true">
				<view class="list">
					<view class="list-item" v-for="(item, index) in list.images" :key="index">
						<u-image @click="navTo(item.url)" width="100%" height="100%" border-radius="8" mode="scaleToFill" :src="item.image"></u-image>
					</view>
				</view>
			</scroll-view>
		</view>
