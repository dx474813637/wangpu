<template>
	<view class="homebg">
		...
		<image 
			class="bigtitle"
			mode="widthFix"
			src="http://dingxiang.netsun.testwebsite.cn/public/img/mb-bigtitle1.jpg"  
			@click="navTo('/pages/prodList/prodList')"
		/>
		<image 
			class="bigtitle u-padding-left-10 u-padding-right-10"
			mode="widthFix"
			src="http://dingxiang.netsun.testwebsite.cn/public/img/mb-lm-4.jpg"  
			@click="navTo('/pages/prodList/prodList')"
		/> -->
